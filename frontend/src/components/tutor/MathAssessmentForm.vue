<template>
  <div class="math-assessment-form">
    <div class="form-card">
      <h2>Math Skill Assessment 📊</h2>
      <p class="form-description">
        How would you rate your child's current math proficiency?
      </p>
...
const emit = defineEmits<{
  complete: [assessment: { proficiency: 'beginner' | 'intermediate' | 'advanced' }]
}>()
...
const proficiencyLevels = [
  {
    ...
    label: 'Beginner',
    icon: '🌱',
    description: 'Just starting with basic math concepts'
  },
  {
    value: 'intermediate' as const,
    label: 'Intermediate',
    icon: '📚',
    description: 'Comfortable with basic operations, ready for more'
  },
  {
...
function handleSubmit() {
  if (selectedProficiency.value) {
    emit('complete', { proficiency: selectedProficiency.value })
  }
}
</script>
